...
public class Cost extends Identifiable implements Serializable {
    ...
    public void setCategory(Category category) {
        if (category == null) {
            throw new CostException("Category can't be empty");
        }
    ...
    public void setOwner(Owner owner) {
        if (owner == null) {
            throw new CostException("Owner can't be empty");
        }
        this.owner = owner;
    }
    ...
    public void setPrice(Double price) {
        if (price <= 0) {
            throw new CostException("Price can't be lower then 0");
        }
        this.price = price;
    }
    ...
    public void setLocation(String location) {
        if (location == null || location.equals("")) {
            throw new CostException("Location can't be empty");
        }
    ...
    public void setDescription(String description) {
        if (description == null || description.equals("")) {
            throw new CostException("Description can't be empty");
        }
    ...
    public boolean equals(Object o) {
        if (o instanceof Cost) {
            return (((Cost) o).getId() == this.getId());
        }
        return false;
    }
}
